...
Name : 			Saikanam Siam
Project :		Linear Regression of Data Points
Peer Reviewer: 		Johnathan Zhao
...
Program Obstacles: 
Finding the proper step size guess first was really hard. The program just didn’t work in a lot of the step sizes. My guess is because the gradient went off of the function. 
 It was also hard to conceptualize what gradient descent means in a discrete summation function. 
Graphing the evolution of the algorithm was really slow at first. Then I just graphed the guess points in a parametric way in 2D space. 
